...
| 任务信号 | 进入 skill |
|---|---|
| Yakit 是什么、怎么安装、界面各功能区干什么、引擎怎么连、新手怎么上手 | [yakit-basic](../yakit-basic/SKILL.md) |
| yak 脚本怎么让 Yakit 显示表格/图表/进度条/卡片/网站树：yakit.* 库函数与 UI 交互机制 | [yakit-ui-binding](../yakit-ui-binding/SKILL.md) |
